...
- Edit text directly on each slide — just click and type
- Upload your own photos into each slide
- Download the whole thing as a `.pptx` file that opens in PowerPoint, Google Slides, etc.
...
Built with React, Vite, pptxgenjs, and html2canvas.
